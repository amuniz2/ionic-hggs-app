...
/* harmony import */ var _services_fake_pantry_data_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/fake-pantry-data.service */ "./src/app/services/fake-pantry-data.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [
                ...
                [{ provide: 'IPantryDataService', useClass: _services_fake_pantry_data_service__WEBPACK_IMPORTED_MODULE_16__["FakePantryDataService"] }]
...
var StoreListComponent = /** @class */ (function () {
    ...
    StoreListComponent.prototype.onAddStoreClick = function () {
        this.newGroceryStoreName = '';
        this.enteringStoreName = true;
        // this.notify.emit('Create new store');
    };
    StoreListComponent.prototype.onCancelAddStoreClick = function () {
        this.enteringStoreName = false;
        this.newGroceryStoreName = '';
    };
    StoreListComponent.prototype.onAddStoreDoneClick = function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"])
    ], StoreListComponent.prototype, "notifyNewStoreRequested", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"])
...
var StoreInventoryManagerPageComponent = /** @class */ (function () {
    ...
    StoreInventoryManagerPageComponent.prototype.onNotifyNewStoreRequest = function ($event) {
        console.log("dispatching createStore " + JSON.stringify(event));
...
/*!****************************************************************************!*\
  !*** ./src/app/modules/store-management/store/store-management.actions.ts ***!
  \****************************************************************************/
/*! exports provided: StoreManagerActionTypes, NavigatedToStoreListPage, NavigateToStoreDetailsPage, StoresLoadedSuccessfully, LoadGroceryStoresFailed, CreateStore, StoreCreated, CreateStoreFailed, DeleteStore, StoreDeleted, DeleteStoreFailed, AddStoreAisle, RemoveStoreAisle, StoreAisleAdded, AddStoreAisleFailed, StoreAisleRemoved, SelectStore, UpdateStore, SelectStoreAisle, UpdateStoreAisle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    function StoreManagementEffects(store, actions$, storeManagementService, router) {
        ...
        this.loadGroceryStores$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_4__["ofType"])(_store_management_actions__WEBPACK_IMPORTED_MODULE_2__["StoreManagerActionTypes"].NavigatedToStoreListPage), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () { return console.log('calling stateManagementService.getGroceryStores()'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () {
            return _this.storeManagementService.getGroceryStores().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (stores) {
                console.log('disatching StoresLoadedSuccessfully action');
                console.log(stores);
        ...
        this.addNewGroceryStore$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_4__["ofType"])(_store_management_actions__WEBPACK_IMPORTED_MODULE_2__["StoreManagerActionTypes"].CreateStore), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (payload) { return console.log('Payload to addNewStore$ ' + JSON.stringify(payload)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (payload) {
            ...
            return _this.storeManagementService.addGroceryStore(payload.createGroceryStorePayload);
        ...
        this.deleteGroceryStore$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_4__["ofType"])(_store_management_actions__WEBPACK_IMPORTED_MODULE_2__["StoreManagerActionTypes"].DeleteStore), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (payload) {
            return _this.storeManagementService.deleteGroceryStore(payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (deletedGroceryStore) { return new _store_management_actions__WEBPACK_IMPORTED_MODULE_2__["StoreDeleted"](deletedGroceryStore); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) { return [new _store_management_actions__WEBPACK_IMPORTED_MODULE_2__["DeleteStoreFailed"](error)]; }));
        }));
...
function groceryStoresReducer(state, action) {
    ...
    switch (action.type) {
        ...
        case _store_management_actions__WEBPACK_IMPORTED_MODULE_1__["StoreManagerActionTypes"].StoreCreated: {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { groceryStores: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _grocery_store_adapter__WEBPACK_IMPORTED_MODULE_2__["groceryStoreAdapter"].addOne(action.payload, state.groceryStores), { loading: false, error: null }) });
        }
        case _store_management_actions__WEBPACK_IMPORTED_MODULE_1__["StoreManagerActionTypes"].StoreDeleted:
            // const { id, name } = action.payload;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { groceryStores: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _grocery_store_adapter__WEBPACK_IMPORTED_MODULE_2__["groceryStoreAdapter"].removeOne(action.payload.id, state.groceryStores), { loading: false, error: null }) });
...
/***/ "./src/app/services/fake-pantry-data.service.ts":
/*!******************************************************!*\
  !*** ./src/app/services/fake-pantry-data.service.ts ***!
  \******************************************************/
/*! exports provided: FakePantryDataService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FakePantryDataService", function() { return FakePantryDataService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var FakePantryDataService = /** @class */ (function () {
    function FakePantryDataService() {
        this.groceryStores = [
            { id: 1, name: 'Publix', aisles: [], locations: [], sections: [] },
            { id: 2, name: 'Target', aisles: [], locations: [], sections: [] },
        ];
    }
    FakePantryDataService.prototype.initialize = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(true);
    };
    FakePantryDataService.prototype.getGroceryStores = function () {
        console.log('Calling dbHelper.getAllGroceryStores()');
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.groceryStores);
    };
    FakePantryDataService.prototype.addGroceryStore = function (newStoreRequest) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(newStore);
    };
    FakePantryDataService.prototype.deleteGroceryStore = function (deleteStoreRequest) {
        var i;
        var groceryStoreDeleted;
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(groceryStoreDeleted);
    };
    FakePantryDataService.prototype.addGroceryStoreAisle = function (newStoreAisleRequest) {
        var i;
        var groceryStore;
        for (i = 0; i < this.groceryStores.length; i++) {
    ...
    FakePantryDataService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], FakePantryDataService);
    return FakePantryDataService;
}());
